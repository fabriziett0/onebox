...
class Azienda(models.Model):
    ...
    attivo = models.BooleanField(default=True, blank=True, null=True)
    bloccato = models.BooleanField(default=False, blank=True, null=True)
    ...
    sedeMain_cap = models.CharField(max_length=5, blank=True, null=True)
    ...
    sedeLegal_cap = models.CharField(max_length=5, blank=True, null=True)
